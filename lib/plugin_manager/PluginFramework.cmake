...
function(__plugin_manager_load_internal JSON_DIR GEN_DIR)
    ...
    foreach(i RANGE ${MAX_I})
        ...
        foreach(j RANGE ${MAX_J})
            ...
            string(APPEND CONTENT "${INTERNAL_PLUGIN_FW_DECLARATION}\n")
        endforeach()
        ...
        if (NOT HAS_INTERFACE EQUAL -1)
            ...
            string(APPEND CONTENT "void *${FUNCTION_NAME}(void);\n")
        endif()
        ...
        if (NOT HAS_INIT EQUAL -1)
            ...
            string(APPEND CONTENT "int32_t ${FUNCTION_NAME}(void* context);\n")
        endif()
