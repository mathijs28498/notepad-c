...
int32_t renderer_vulkan_copy_buffer_data(struct RendererContext *context, struct RendererCommandList *command_list, struct RendererCopyBufferDataInfo *download_buffer_data_info);
