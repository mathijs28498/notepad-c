...
bool window_win32_plugin_window_events_pop(WindowApiContext *context, WindowEvent *window_event)
{
...
void window_win32_plugin_window_events_push(WindowApiContext *context, WindowEvent const *window_event)
{
